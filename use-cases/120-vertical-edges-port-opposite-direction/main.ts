...
const addNode1Request: AddNodeRequest = createInOutNode({
  ...
  x: 200,
  y: 200,
  frontPort: { id: "node-1-front", direction: Math.PI / 2 },
  backPort: { id: "node-1-back", direction: Math.PI / 2 },
});
...
const addNode2Request: AddNodeRequest = createInOutNode({
  ...
  x: 400,
  y: 400,
  frontPort: { id: "node-2-front", direction: Math.PI / 2 },
  backPort: { id: "node-2-back", direction: -Math.PI / 2 },
});
...
const addNode3Request: AddNodeRequest = createInOutNode({
  ...
  x: 700,
  y: 200,
  frontPort: { id: "node-3-front", direction: -Math.PI / 2 },
  backPort: { id: "node-3-back", direction: Math.PI / 2 },
});
...
const addNode4Request: AddNodeRequest = createInOutNode({
  ...
  x: 900,
  y: 400,
  frontPort: { id: "node-4-front", direction: Math.PI / 2 },
  backPort: { id: "node-4-back", direction: Math.PI / 2 },
});
