...
canvas
  ...
  .addNode({ element: node1, x: 400, y: 450, ports: ports1, priority: 4 })
  .addNode({ element: node2, x: 450, y: 500, ports: ports2, priority: 3 })
  .addNode({ element: node3, x: 500, y: 550, ports: ports3, priority: 2 })
  .addNode({ element: node4, x: 550, y: 600, ports: ports4, priority: 1 })
  .addEdge({ from: "port-1-2", to: "port-2-1", priority: 0 })
  .addEdge({ from: "port-3-2", to: "port-4-1", priority: 0 })
  .addEdge({ from: "port-2-2", to: "port-3-1", priority: 0 });
