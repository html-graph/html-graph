...
import { ConnectionCategory, EdgeShape } from "../shared";
import { OrthogonalEdgeShape } from "./orthogonal-edge-shape";
...
describe("OrthogonalEdgeShape", () => {
  it("should create line path without arrows", () => {
    const shape = createOrthogonalEdge(false, false);
  ...
  it("should create line path accounting for target arrow", () => {
    const shape = createOrthogonalEdge(false, true);
  ...
  it("should create line path accounting for source arrow", () => {
    const shape = createOrthogonalEdge(true, false);
  ...
  it("should create node cycle line path without arrows", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 50 50 L 65 50 C 70 50 70 50 70 55 L 70 245 C 70 250 70 250 75 250 L 125 250 C 130 250 130 250 130 245 L 130 155 C 130 150 130 150 135 150 L 150 150",
    );
  });
  ...
  it("should create node cycle line path accounting for target arrow", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 50 50 L 65 50 C 70 50 70 50 70 55 L 70 245 C 70 250 70 250 75 250 L 125 250 C 130 250 130 250 130 245 L 130 155 C 130 150 130 150 135 150 L 140 150",
    );
  });
