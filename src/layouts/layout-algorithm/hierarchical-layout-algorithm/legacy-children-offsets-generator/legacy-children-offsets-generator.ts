...
import { LegacyChildrenOffsetsGeneratorParams } from "./legacy-children-offsets-generator-params";
import { LayerNodePlacementResolver } from "./layer-node-placement-resolver";

export class LegacyChildrenOffsetsGenerator {
  ...
  public constructor(
    ...
    params: LegacyChildrenOffsetsGeneratorParams,
  ) {
