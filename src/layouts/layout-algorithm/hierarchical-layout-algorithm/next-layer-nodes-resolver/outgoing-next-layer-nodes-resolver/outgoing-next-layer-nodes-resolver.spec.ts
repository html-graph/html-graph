...
import { outgoingNextLayerNodesResolver } from "./outgoing-next-layer-nodes-resolver";

describe("outgoingNextLayerNodesResolver", () => {
  it("should return empty array when node has no adjacent nodes", () => {
    ...
    const nextNodes = outgoingNextLayerNodesResolver({
      graph: canvas.graph,
