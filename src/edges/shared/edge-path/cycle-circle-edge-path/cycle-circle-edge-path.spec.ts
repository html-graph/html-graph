...
describe("CycleCircleEdgePath", () => {
  it("should create cycle circle path without arrows", () => {
    ...
    expect(edgePath.path).toBe(
      "M 0 0 L 15 0 M 15 0 A 10 10 0 0 1 24.79795897113271 8 A 40 40 0 1 0 24.79795897113271 -8 A 10 10 0 0 1 15 0",
    );
  });
  ...
  it("should create cycle circle path with source arrow", () => {
    ...
    expect(edgePath.path).toBe(
      "M 15 0 A 10 10 0 0 1 24.79795897113271 8 A 40 40 0 1 0 24.79795897113271 -8 A 10 10 0 0 1 15 0",
    );
  });
