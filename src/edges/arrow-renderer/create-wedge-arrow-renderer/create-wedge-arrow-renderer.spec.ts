...
describe("createWedgeArrowRenderer", () => {
  it("should create arrow path", () => {
    ...
    expect(path).toBe(
      "M 0 0 A 30 30 0 0 1 22.343145750507617 5.656854249492378 A 8 8 0 0 1 22.343145750507617 -5.656854249492378 A 30 30 0 0 1 0 0",
    );
  });
  ...
  it("should create rotated arrow path", () => {
    ...
    expect(path).toBe(
      "M 0 0 A 30 30 0 0 1 -5.656854249492378 22.343145750507617 A 8 8 0 0 1 5.656854249492378 22.343145750507617 A 30 30 0 0 1 0 0",
    );
  });
  ...
  it("should create shifted arrow path", () => {
    ...
    expect(path).toBe(
      "M 5 10 A 30 30 0 0 1 27.343145750507617 15.656854249492378 A 8 8 0 0 1 27.343145750507617 4.343145750507622 A 30 30 0 0 1 5 10",
    );
  });
});
