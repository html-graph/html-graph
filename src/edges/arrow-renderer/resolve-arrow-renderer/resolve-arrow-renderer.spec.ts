...
describe("resolveArrowRenderer", () => {
  it("should resolve circle arrow renderer by default", () => {
  ...
  it("should resolve circle arrow renderer with specified radius", () => {
    const renderer = resolveArrowRenderer({ type: "circle", radius: 15 });
    const direction: Point = { x: 1, y: 0 };
    const shift: Point = { x: 0, y: 0 };
  ...
  it("should resolve polygon arrow renderer with specified radius", () => {
    const renderer = resolveArrowRenderer({ type: "polygon", radius: 10 });
    const direction: Point = { x: 1, y: 0 };
    const shift: Point = { x: 0, y: 0 };
