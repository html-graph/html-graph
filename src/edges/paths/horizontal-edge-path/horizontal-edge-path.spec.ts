...
describe("HorizontalEdgePath", () => {
  ...
  it("should create horizontal line path with source arrow", () => {
    ...
    expect(edgePath.path).toBe(
      "M 115 100 L 115 100 C 120 100 120 100 130 100 L 140 100 C 150 100 150 100 150 110 L 150 290 C 150 300 150 300 160 300 L 170 300 C 180 300 180 300 190 300 L 200 300",
    );
  });
  ...
  it("should create horizontal line path with target arrow", () => {
    ...
    expect(edgePath.path).toBe(
      "M 100 100 L 110 100 C 120 100 120 100 130 100 L 140 100 C 150 100 150 100 150 110 L 150 290 C 150 300 150 300 160 300 L 170 300 C 180 300 180 300 185 300 L 185 300",
    );
  });
