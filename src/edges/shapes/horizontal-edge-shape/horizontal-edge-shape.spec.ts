...
describe("HorizontalEdgeShape", () => {
  it("should create line path without arrows", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 0 0 L 15 0 C 20 0 20 0 25 0 L 45 0 C 50 0 50 0 50 5 L 50 95 C 50 100 50 100 55 100 L 75 100 C 80 100 80 100 85 100 L 100 100",
    );
  });
  ...
  it("should create line path accounting for target arrow", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 0 0 L 15 0 C 20 0 20 0 25 0 L 45 0 C 50 0 50 0 50 5 L 50 95 C 50 100 50 100 55 100 L 75 100 C 80 100 80 100 85 100 L 90 100",
    );
  });
  ...
  it("should create line path accounting for source arrow", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 10 0 L 15 0 C 20 0 20 0 25 0 L 45 0 C 50 0 50 0 50 5 L 50 95 C 50 100 50 100 55 100 L 75 100 C 80 100 80 100 85 100 L 100 100",
    );
  });
  ...
  it("should create node cycle line path without arrows", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 0 0 L 15 0 C 20 0 20 0 20 5 L 20 195 C 20 200 20 200 25 200 L 75 200 C 80 200 80 200 80 195 L 80 105 C 80 100 80 100 85 100 L 100 100",
    );
  });
  ...
  it("should create node cycle line path accounting for target arrow", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 0 0 L 15 0 C 20 0 20 0 20 5 L 20 195 C 20 200 20 200 25 200 L 75 200 C 80 200 80 200 80 195 L 80 105 C 80 100 80 100 85 100 L 90 100",
    );
  });
  ...
  it("should create node cycle line path accounting for source arrow", () => {
    ...
    expect(line.getAttribute("d")).toBe(
      "M 10 0 L 15 0 C 20 0 20 0 20 5 L 20 195 C 20 200 20 200 25 200 L 75 200 C 80 200 80 200 80 195 L 80 105 C 80 100 80 100 85 100 L 100 100",
    );
  });
});
